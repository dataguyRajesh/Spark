...
mysql_port_no = "3306"
mysql_database_name = "event_message_db"
mysql_driver_class = "com.mysql.jdbc.Driver"
mysql_table_name = "dashboard_event_message_detail_agg_tbl"
...
def save_to_mysql(current_df, epoc_id):
    ...
    current_df_final \
        .select(["event_country_code", "event_country_name", "event_city_name", "event_server_status_color_name", "event_server_status_severity_level", "total_estimated_resolution_time", "total_message_count"]) \
        .write \
...
if __name__ == "__main__":
    ...
    spark = SparkSession \
        ...
        .appName("Real-Time Streaming Data Pipeline") \
        .master("local[*]") \
        .config("spark.jars.packages", "org.apache.spark:spark-sql-kafka-0-10_2.12:3.0.1,mysql:mysql-connector-java:5.1.49") \
        .getOrCreate()
    ...
    hdfs_event_message_path = "hdfs://localhost:9000/data/json/event_message_detail_raw_data"
    hdfs_event_message_checkpoint_location_path = "hdfs://localhost:9000/data/checkpoint/event_message_detail_raw_data"
    ...
    postgresql_table_name = "dashboard_event_message_detail_agg_tbl"
    ...
    .trigger(processingTime='20 seconds') \
    .outputMode("update") \
    .foreachBatch(lambda current_df, epoc_id: save_to_mysql(current_df, epoc_id)) \
    .start()
